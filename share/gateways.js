...
export async function loadGatewayOrigins() {
...
export function gatewayURL(origin, cid) {
  return `${origin.replace(/\/$/, "")}/ipfs/${encodeURIComponent(cid)}`
}

export function gatewayLabel(origin) {
  try {
...
export function gatewayHostname(origin) {
  try {
